...
export default function KilimanjaroSection() {
  ...
  return (
    ...
    >
      ...
      <img
        ref={bgRef}
        src="/images/kilimanjaro_summit.jpg"
      ...
      <div className="relative z-10 h-full flex flex-col items-center">
        ...
        >
          <span className="label-mono text-[#B7C0B3]">MOUNTAIN EXPEDITION</span>
        </div>
        ...
        >
          Climb to the Roof of Africa. Choose your route, pace, and season—guided by experienced high-altitude teams.
        </p>
