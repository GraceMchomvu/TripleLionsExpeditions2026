  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col items-center">
        ...
        >
          <span className="label-mono text-[#B7C0B3]">BEACH EXTENSION</span>
        </div>

        {/* Center headline */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center w-[92vw]">
          <div ref={headline1Ref} className="headline-section text-[#F4F1EA] text-[clamp(40px,10vw,140px)]">
            ZANZIBAR
          </div>
        ...
        >
          End your safari on the Spice Island—clear water, historic Stone Town, and quiet coastal villages.
        </p>
        ...
        >
          <span className="text-sm font-medium">Add Zanzibar</span>
