...
export default function BigFiveSection() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Headline line 2 from bottom (slightly after)
      scrollTl.fromTo(
      ...
      scrollTl.fromTo(
        bgRef.current,
        { scale: 1, opacity: 1 },
        { scale: 1.06, opacity: 0.8, ease: 'none' },
        0.7
      );
  ...
  return (
    ...
    >
      ...
      <img
        ref={bgRef}
        src="/images/elephant_closeup.jpg"
      ...
      <div className="relative z-10 h-full flex flex-col items-center">
        ...
        >
          <span className="label-mono text-[#B7C0B3]">SIGNATURE EXPERIENCE</span>
        </div>

        {/* Center headline */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center w-[92vw]">
          <div ref={headline1Ref} className="headline-section text-[#F4F1EA] text-[clamp(48px,10vw,140px)]">
            THE BIG
          </div>
          <div ref={headline2Ref} className="headline-section text-[#F4F1EA] text-[clamp(64px,14vw,180px)]">
            FIVE
          </div>
        </div>
        ...
        >
          Track lion, leopard, elephant, buffalo, and rhino across vast plains with expert guides who read the land like a map.
        </p>
        ...
        >
          <span className="text-sm font-medium">View Big Five itineraries</span>
